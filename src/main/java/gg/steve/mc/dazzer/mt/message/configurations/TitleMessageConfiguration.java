package gg.steve.mc.dazzer.mt.message.configurations;

import gg.steve.mc.dazzer.mt.message.PluginMessage;
import gg.steve.mc.dazzer.mt.utility.ColorUtil;
import gg.steve.mc.dazzer.mt.xseries.messages.Titles;
import lombok.Data;
